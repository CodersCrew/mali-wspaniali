            ...
            '%c' +
                `Path: ${
                    isQuerySnapshot(snapshot)
                        ? getQueryDocumentPath((snapshot as unknown) as QuerySnapshotWithExtendedQuery)
                        : snapshot.ref.path
                }
...
function isQuerySnapshot(snapshot: QuerySnapshot | DocumentSnapshot): snapshot is QuerySnapshot {
