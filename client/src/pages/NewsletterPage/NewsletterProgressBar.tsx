...
export const NewsletterProgressBar: React.FC<{
    ...
    const setElement = (name: string) => {
        const number =
            name === ProgressBarNames.firstStep
                ? ProgressBarContent.one
                : ProgressBarContent.two;
        switch (
            name === ProgressBarNames.firstStep
                ? progressBarState.firstStep
                : progressBarState.secondStep
        ) {
            ...
            case ProgressBarStates.Done:
                return (
                    <>
                        ...
                        <span className={`${classes.text} inactive`}>
                            {t('newsletter.sidebar.done')}
                        </span>
                    </>
                );
            ...
            case ProgressBarStates.FileError:
                return (
                    <>
                        <WarningIcon className={classes.iconError} />
                        <span className={classes.text}>
                            {t('newsletter.sidebar.file-error')}
                        </span>
                    </>
                );
            default:
