...
import { CategoryTabsMobile } from '../ArticleListPage/CategoryTabsMobile';
import { CategoryTabs } from '../ArticleListPage/CategoryTabs';
...
export function MobileAwareCategoryTabs<
    T extends CategoryItem | ChildProfileCategoryItem
>({ device, category, values, onTabChange }: Props<T>) {
