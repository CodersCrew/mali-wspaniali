...
import { menuItemFactory, blogMenuItemFactory, adminMenuItemFactory } from './menuItemFactory';
...
export const AdminSidebar = ({ onClick, onClose, user, active, open }: Props) => {
    ...
    const MainPageItem = adminMenuItemFactory({ name: 'main-page', active, t });
    const ResultsItem = adminMenuItemFactory({ name: 'results', active, t });
